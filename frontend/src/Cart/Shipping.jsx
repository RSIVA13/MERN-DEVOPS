...
function Shipping() {
    ...
    const shippingInfoSubmit=(e)=>{
        ...
        if(phoneNumber.length!==10){
            toast.error('Invalid PhoneNumber ! it should be 10 digits',{position:'top-center',autoClose:3000})
            return;
        }
        ...
        <form  className="shipping-form" onSubmit={shippingInfoSubmit}>
            <div className="shipping-section">
                ...
                <div className="shipping-form-group">
                    ...
                    <input type="number" id='pincode' name='pincode' value={pinCode} onChange={(e)=>setPinCode(e.target.value)}  placeholder='Enter Your Pincode'/>
                </div>
                <div className="shipping-form-group">
                    <label htmlFor="phoneNumber">PhoneNumber</label>
                    <input type="tel" id='phoneNumber' name='phoneNumber' value={phoneNumber} onChange={(e)=>setPhoneNumber(e.target.value)} placeholder='Enter Your phoneNumber'/>
                </div>
            </div>
